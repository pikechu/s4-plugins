...
if ($running.Count -gt 0) {
    throw "Close S4_Main and Settlers United before archive restoration: $($running.ProcessName -join ', ')"
}
...
Restore-CampaignCompletionArtifact -ArchivePath $archive -BackupDirectory $backup
